import type { GroomingStep, GroomingStatus, PaketGrooming, GroomingSession } from '@/types/pos.types'
...
// Initial demo sessions for testing before DB migrations are run
